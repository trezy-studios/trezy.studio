	...
	return (
		<PageContent>
			<PageSection
				alignment={'left'}
				useSmallGaps>
				<p><em>{'This policy is effective as of January 1, 2022.'}</em></p>

				{/* eslint-disable-next-line react/jsx-first-prop-new-line */}
				<p>{'Your privacy is important to us. It is Trezy Studios\' policy to respect your privacy regarding any information we may collect from you across our website, '}<Link href={'/'
				}>{'http://trezy.studio'}</Link>{', and other sites we own and operate.'}</p>
			</PageSection>
			...
			<PageSection
				...
				<ul className={'bulleted'}>
					<li>{'Vercel ('}<Link href={'/documents/zeit-trezycom.data-processing-agreement.pdf'}>{'Data Processing Agreement'}</Link>{')'}</li>
				</ul>
			...
			<PageSection
				...
				<p>
					<strong>{'Trezy Studios Data Controller & Data Protection Officer'}</strong>
					<br />
					{'Trezy'}<br />
					<Link href={'mailto:data@trezy.studio'}>{'data@trezy.studio'}</Link>
				</p>
			</PageSection>
		</PageContent>
	)
