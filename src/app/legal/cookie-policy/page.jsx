	...
	return (
		<PageContent>
			<PageSection
				alignment={'left'}
				useSmallGaps>
				<p>{'We use cookies to help improve your experience of '}<Link href={'/'}>{'http://trezy.studio'}</Link>{'. This cookie policy is part of Trezy Studios privacy policy, and covers the use of cookies between your device and our site. We also provide basic information on third-party services we may use, who may also use cookies as part of their service, though they are not covered by our policy.'}</p>

				<p>{'If you don\'t wish to accept cookies from us, you should instruct your browser to refuse cookies from '}<Link href={'/'}>{'http://trezy.studio'}</Link>{', with the understanding that we may be unable to provide you with some of your desired content and services.'}</p>
			</PageSection>
